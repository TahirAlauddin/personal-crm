...
import NoteEditor from "@/components/richtexteditor";
      ...
      <div className="flex flex-col">
        ...
        <div className="flex p-6">
          ...
          {selectedNote !== null && (
            ...
            //   <div className="flex flex-col bg-white border-b z-10">
            ...
            //   </div>
            // </div>
            <NoteEditor selectedNote={selectedNote} setSelectedNote={setSelectedNote} />
          )}
        </div>
      </div>
    </div>
